        ...
        <div className='flex flex-col px-6 py-12 gap-12 md:px-16 md:py-16'>
          ...
          <main className='flex flex-col gap-4 w-full md:flex-row md:items-start lg:gap-32'>
            <div className='flex items-center justify-start w-full gap-3 md:flex-col md:w-60 md:gap-2'>
              <Link href="/encryption" className='px-4 py-2 rounded-2xl bg-red-pantone text-base leading-normal font-medium text-antiflash-white hover:shadow-hover md:w-full md:py-4 md:px-6'>Criptografar</Link>
              <Link href="/decryption" className='px-4 py-2 rounded-2xl bg-raisin-black text-base leading-normal font-medium text-cool-gray hover:shadow-hover md:w-full md:py-4 md:px-6'>Descriptografar</Link>
            </div>
